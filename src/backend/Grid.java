...
import backend.BoundaryBehavior;
...
public class Grid {
  ...
  public Grid(Dimension size, BiIndex<Color> colorMap, BiIndex<String> imageMap) {
    ...
    myBoundaryBehavior = new WindowBoundaryBehavior(size.height, size.width);
  ...
  public Dimension getDimension() {
    ...
    size.setSize(myBoundaryBehavior.getWidth(), myBoundaryBehavior.getHeight());
    return size;
  }
  ...
  public Turtle getTurtleById(int id) {
    if (allTurtles.containsKey(id)) {
      ...
      Turtle newTurtle = new Turtle(id, colorMap, imageMap, myBoundaryBehavior);
  ...
  public void setDimensions(int width, int height) {
    myBoundaryBehavior.setWidth(width);
    myBoundaryBehavior.setHeight(height);
  }

  public void setBoundaryBehavior(BoundaryBehavior boundary) {
    myBoundaryBehavior = boundary;
  }
  public BoundaryBehavior getBoundaryBehavior() {
    return myBoundaryBehavior;
  }
