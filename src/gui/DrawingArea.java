...
public class DrawingArea extends Region {
	...
	public DrawingArea(double drawingAreaWidth, double drawingAreaHeight,  double drawingAreaXLocation, double drawingAreaYLocation){
		...
		drawShapes(this.drawingCanvas.getGraphicsContext2D());
